...
data modify block ~0 ~0 ~-1 Command set value "clone 0 6 88 26 30 100 0 6 88 replace move"
...
data modify block ~0 ~0 ~-3 Command set value "clone 0 6 88 26 30 100 0 5 88 replace move"
...
data modify block ~0 ~0 ~-5 Command set value "clone 0 5 88 26 29 100 0 4 88 replace move"
